    ...
    if(msg.content.includes('安安')){ //隨機回答 安安
        ...
        switch(num){
            ...
            case 23:msg.channel.send('你不是真心在意') ;break ;
            case 24:msg.channel.send('這具有重大意義') ;break ;
            case 25:msg.channel.send('信你的直覺') ;break ;
            case 26:msg.channel.send('船到橋頭自然直') ;break ;
            case 27:msg.channel.send('船到橋頭自然沉') ;break ;
            case 28:msg.channel.send('等待一個更好的時機') ;break ;
            case 29:msg.channel.send('等待一個更好的時機') ;break ;
            case 30:msg.channel.send('owo') ;break ;
